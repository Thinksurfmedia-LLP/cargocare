...
export default [
  ...
  route("pending-approvals", "routes/pending-approvals.tsx"),
  ...
  route("api/export-csv", "routes/api.export-csv.tsx"),
  route("api/export-filter-options", "routes/api.export-filter-options.tsx"),
  ...
  route("shipment-assignments/:id/edit", "routes/shipment-assignments.$id.edit.tsx"),
